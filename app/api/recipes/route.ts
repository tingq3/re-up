...
const FALLBACK: RecipeMatch[] = [
  {
    ...
    used: [
      { name: "Baby spinach", quantity: "1 bag" },
      { name: "Cooked chicken", quantity: "250 g" },
      { name: "Eggs", quantity: "6 large" },
      { name: "Cheddar", quantity: "150 g" },
    ],
    missing: [],
    calories: 342,
    protein: 29,
  ...
  },
  {
    ...
    used: [
      { name: "Baby spinach", quantity: "2 handfuls" },
  ...
  },
  {
    ...
    missing: [{ name: "Vegetable stock", quantity: "500 ml" }],
    calories: 285,
    protein: 16,
    carbs: 19,
    fat: 16,
